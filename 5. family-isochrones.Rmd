...
daycare_sf <- read_sf(paste0("Shapefiles/daycare_locations.shp"))

prov_isos <- read_sf(paste0(path, "Shapefiles/provider_isochrones.shp")) %>% st_set_geometry(NULL)
```
...
map_supply_point <- tm_shape(lakeview_buff_3435) + tm_borders() +
