...
```{r select-decennial-variables, eval=FALSE, include=FALSE}
...
```{r extract-decennial-data, eval=FALSE}
...
```{r transform-decennial-data, eval=TRUE}
...
```{r get-block-geometry, eval=FALSE}
